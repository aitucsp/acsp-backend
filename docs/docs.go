    ...
    "paths": {
        "/api/v1/admin/contests/{id}": {
            "put": {
                ...
                "operationId": "update-contest-by-id",
                "parameters": [
                    {
                        "type": "integer",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateContest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "operationId": "delete-contest-by-id",
                "parameters": [
                    {
                        "type": "string",
                        "description": "contest id",
        ...
        "/api/v1/code-connection/cards/{id}/invitations/{invitationID}/accept": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "accept invitation feedback",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.AnswerInvitation"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/code-connection/cards/{id}/invitations/{invitationID}/decline": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "decline invitation feedback",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/coding-lab/admin/contests": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateContest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/coding-lab/discipline/{id}": {
            "get": {
                ...
                "operationId": "get-discipline-by-id",
                "parameters": [
                    {
                        "type": "integer",
            ...
            "delete": {
                ...
                "operationId": "delete-discipline-by-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "discipline id",
        ...
        "/api/v1/coding-lab/disciplines": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "discipline information",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateDiscipline"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/coding-lab/disciplines/{id}": {
            "put": {
                ...
                "operationId": "update-discipline-by-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "discipline id",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateDiscipline"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/coding-lab/disciplines/{id}/projects": {
            "get": {
                ...
                "operationId": "get-all-projects-by-discipline-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "discipline id",
        ...
        "/api/v1/course/{id}/modules/{moduleID}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "get-course-module-by-id",
                "parameters": [
                    {
                        "type": "integer",
        ...
        "/api/v1/course/{id}/modules/{moduleID}/lessons/{lessonID}": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "get-course-module-lesson-by-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "course id",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateCourse"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/courses/{id}/lessons/{lessonID}/comments": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "summary": "Get a course module by id",
                "operationId": "get-lesson-comments-by-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "course id",
            ...
            "post": {
                ...
                "operationId": "create-lesson-comment",
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateLessonComment"
                        }
                    },
                    {
                        "type": "integer",
        ...
        "/api/v1/courses/{id}/modules": {
            "get": {
                ...
                "operationId": "get-all-course-modules",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
            ...
            "post": {
                ...
                "summary": "Create a module for a course",
                "operationId": "create-course-module",
                "parameters": [
                    {
                        "description": "module information",
                        "name": "request",
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateCourseModule"
                        }
                    },
                    {
                        "type": "integer",
        ...
        "/api/v1/courses/{id}/modules/{moduleID}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "update-course-module-by-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "course id",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateCourseModule"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "operationId": "delete-course-module-by-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "project id",
        ...
        "/api/v1/courses/{id}/modules/{moduleID}/lessons": {
            "get": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "get-all-course-module-lessons",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "course id",
            ...
            "post": {
                ...
                "operationId": "create-course-module-lesson",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "course id",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.CreateCourseModuleLesson"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/courses/{id}/modules/{moduleID}/lessons/{lessonID}": {
            "put": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "operationId": "update-course-module-lesson-by-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "course id",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.UpdateCourseModuleLesson"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "operationId": "delete-course-module-lesson-by-id",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "course id",
